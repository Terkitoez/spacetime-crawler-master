...
from datamodel.search.Ramong1DyambaoNellyj_datamodel import Ramong1DyambaoNellyjProjectionLink
...
@Deleter(Ramong1DyambaoNellyjProjectionLink)
@Getter(Ramong1DyambaoNellyjProjectionLink)
class DeleteFrontierFrame(IApplication):
    ...
    def update(self):
        ...
        ls = self.frame.get(Ramong1DyambaoNellyjProjectionLink)
        print "Found ", len(ls), " links to delete."
        for l in ls:
            self.frame.delete(Ramong1DyambaoNellyjProjectionLink, l)
